        ...
        <View style={{ backgroundColor: 'black' }}>
            <View style={{ padding: 20 }}>
                ...
                <View style={{ marginTop: 20 }}>
                    ...
                    />
                    <TextInput style={{ padding: 10, backgroundColor: "whitesmoke", marginTop: 10, borderRadius: 20 }} placeholder="Enter email"
                        autoCapitalize='none'
                        autoCorrect={false}
                        value={email}
                    ...
                    <TextInput style={{ padding: 10, backgroundColor: "whitesmoke", marginVertical: 10, borderRadius: 20 }} placeholder="+880........."
                        autoCapitalize='none'
                        autoCorrect={false}
                        value={cardNumber}
            ...
            >
                <Text style={{ marginTop: -16, marginBottom: 32 }}>Successfully payment</Text>
            </FancyAlert>
        </View>
